 ...
 *
 * Policy (see docs/android.md, "WakeWordGate battery policy"):
 ...
 *
 * Deliberately standalone: callers inject plain booleans (home zone state
 * from the HA server / companion sensors, car BT from BluetoothProfile
 * callbacks) and the current hour. No Android imports, so the class is
...
class WakeWordGate(
    ...
    /**
     * @param isHome device is inside the HA "home" zone
