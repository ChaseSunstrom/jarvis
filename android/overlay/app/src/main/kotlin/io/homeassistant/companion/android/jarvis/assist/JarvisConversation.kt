...
import io.homeassistant.companion.android.jarvis.JarvisConfig
import io.homeassistant.companion.android.jarvis.JarvisOrbView

/**
 * The Jarvis conversation engine, shared by the activation popup
 * (JarvisAssistActivity) and the home screen (JarvisHomeActivity) so both
 * behave identically.
 *
 * Owns the mic, the HA pipeline WebSocket client, TTS playback, an energy VAD,
