 ...
 * shared [JarvisConversation] engine; it never shows Home Assistant's own
 * assist UI. Auto-closes on inactivity, a tap, or Back.
 */
class JarvisAssistActivity : Activity(), JarvisConversation.Ui {
    ...
    private fun buildUi(): ViewGroup {
        ...
        root.addView(texts, FrameLayout.LayoutParams(
