...
export const TOKENS = {
	...
	'--jv-ease-standard': 'cubic-bezier(0.22, 0.61, 0.36, 1)',
	'--jv-ease-decelerate': 'cubic-bezier(0, 0, 0.2, 1)',
	'--jv-ease-accelerate': 'cubic-bezier(0.4, 0, 1, 1)',
	'--jv-ease-spring': 'cubic-bezier(0.34, 1.56, 0.64, 1)',
