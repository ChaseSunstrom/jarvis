...
/**
 * Trampoline session: shows no UI of its own; on assist invocation it launches
 * [JarvisAssistActivity] and immediately finishes. This is the standard pattern
 * for apps whose assist experience is an activity rather than a system overlay
 * panel.
 */
