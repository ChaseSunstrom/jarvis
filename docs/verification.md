...
| A 2-second median round trip | **Missed, and reported** | 2.51 s median, 14.55 s p95 on 27 Aug 2026 (the 09:47 report run of 98 scenarios; 4.17 s and 21.4 s in that morning's run of 63; 15–20 s when first measured on 24 Aug, before M60/M70/M74) on this host (27 B model, no GPU, four shared vCPUs). `ISSUES.md` and `BLOCKERS.md` say what it would take |
