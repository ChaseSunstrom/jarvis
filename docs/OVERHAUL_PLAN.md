...
| M66 | **Ask and answer** — the operator's reports: the voice speaks the reply and the question; a question expires in five minutes and the answer then fails; an answer or a confirmation should be sayable. | `m66-ask-and-answer.sh` | M43, M60 |
