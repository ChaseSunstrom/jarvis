...
{:else}
	{#if canCreate}
		<section class="panel" data-testid="code-repos">
			...
			<div class="toolbar">
				<Button variant="primary" testid="code-new-repo"
				...
				{#if forges.length}
					<Button variant="primary" testid="code-clone-repo"
			...
			{#if cloning}
				<div class="editor" data-testid="code-clone-form">
					...
					<div class="row">
						<Button variant="primary" testid="clone-start"
							disabled={saving ||
								!!projectProblem ||
								!!cloneNameProblem ||
								!cloneProject.trim()}
			...
			{#if creating}
				<div class="editor" data-testid="code-repo-form">
					...
					<div class="row">
						<Button variant="primary" testid="repo-create"
	...
	<section class="panel" data-testid="code-new">
		...
		<div class="row">
			<Button variant="primary" testid="code-start"
		...
		<div class="stack jv-stagger" data-testid="code-jobs">
			{#each mine as job, i (job.id)}
				<div style={staggerStyle(i)}>
					...
					<div class="opener">
						<Button testid="code-open-{job.id}"
