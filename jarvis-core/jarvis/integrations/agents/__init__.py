...
def _register_tool(jarvis: "Jarvis") -> None:
    ...
    registry.register(
        ...
        description=(
            ...
            "subsystem: 'research' for a cited web report across several "
            "sources, 'code' for a coding job. One page or document to read, "
            "summarise or check is a specialist by name (the summarizer, the "
            "verifier), not 'research'. Pieces of different shape go to "
            "different workers. THIS is the tool when the user asks for two or more separate "
