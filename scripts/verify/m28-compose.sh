#!/usr/bin/env bash
# M28 — the compose stack: pinned, healthy, described. Written when the milestone is built; until then it fails,
...
_v_fail "M28 is not built yet — see its scope in MILESTONES.md" ""
verify_end
