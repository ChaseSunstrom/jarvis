#!/usr/bin/env bash
# M33 — embeddings and reranking as services. Written when the milestone is built; until then it fails,
...
_v_fail "M33 is not built yet — see its scope in MILESTONES.md" ""
verify_end
