...
check "the phone says recording-now before it opens the microphone" grep -qE "Thread \{ client\??\.enrolling\(\) \}\.start\(\)" android-app/app/src/main/kotlin/ai/jarvis/app/VoiceIdentityActivity.kt
