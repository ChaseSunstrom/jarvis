#!/usr/bin/env bash
# M32 — crawling and document extraction. Written when the milestone is built; until then it fails,
...
_v_fail "M32 is not built yet — see its scope in MILESTONES.md" ""
verify_end
