#!/usr/bin/env bash
# M35 — speech as services, and a TTS A/B. Written when the milestone is built; until then it fails,
...
_v_fail "M35 is not built yet — see its scope in MILESTONES.md" ""
verify_end
